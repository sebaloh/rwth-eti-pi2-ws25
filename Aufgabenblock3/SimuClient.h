...
#define SIMUSERVER_DEFAULT_PORT "7654"
#define SIMUSERVER_DEFAULT_HOST "localhost"
...
*/
SIMUCLIENT_API bool bInitialisiereGrafik(int iFenstergroesseX, int iFenstergroesseY, const char* adresse = "127.0.0.1", const char* port = nullptr);
